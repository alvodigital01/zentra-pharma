...
export const products = [
  ...
  },
  {
    ...
    images: [
      ...
      "/images/products/lipolandnova.png",
...
export const catalogProducts: ReadonlyArray<{
  ...
  },
  {
    ...
    cardPrice: 1018.65,
    cardInstallments: 5,
    cardInstallmentPrice: 203.73,
    image: "/images/products/retratutideusa-40mg-2ml.webp",
  },
  {
  ...
  },
  {
    ...
    cardPrice: 1093.2,
    cardInstallments: 5,
    cardInstallmentPrice: 218.64,
    image: "/images/products/retatrutidaalluvi.png",
  },
  {
    title: "Retatrutida Gen Health",
    presentation: "GLP-1 + GIP + Glucagon | 60mg",
    units: "Ampola única",
    pixPrice: 999,
    cardPrice: 1095.4,
  ...
  },
  {
    title: "AOD-9604",
    family: "Peptídeo",
    presentation: "AOD-9604 | 10mg",
    units: "Ampola única",
    pixPrice: 549,
    cardPrice: 602,
    cardInstallments: 5,
    cardInstallmentPrice: 120.4,
    image: "/images/products/aod.png",
    section: "AOD-9604",
  },
  {
  ...
  {
    title: "Tizerpatida Lipoland MD",
    presentation: "GIP + GLP-1 | 60mg",
    units: "Multidose",
    pixPrice: 1129,
    cardPrice: 1237.95,
    cardInstallments: 5,
    cardInstallmentPrice: 247.59,
    image: "/images/products/lipolandnova.png",
  },
  {
    title: "Tizerpatida TG",
...
export const productSectionDetails: Partial<Record<string, {
  ...
  "AOD-9604": {
    title: "O que é AOD-9604?",
    paragraphs: [
      "O AOD-9604 é um peptídeo sintético derivado de um fragmento específico do hormônio do crescimento humano (hGH), desenvolvido com foco na sua atuação sobre mecanismos relacionados ao metabolismo lipídico.",
      "O AOD-9604 está associado principalmente aos processos de lipólise e lipogênese, relacionados à mobilização, utilização e armazenamento de gordura pelo organismo. Por utilizar apenas um fragmento específico do hGH, apresenta características diferentes do hormônio do crescimento completo.",
    ],
    benefitsTitle: "Principais características do AOD-9604",
    benefits: [
      "Atuação relacionada ao metabolismo de gorduras",
      "Associação aos mecanismos de lipólise",
      "Influência estudada sobre os processos de lipogênese",
      "Relação com a mobilização de gordura armazenada",
      "Atuação estudada no metabolismo energético",
      "Derivado de um fragmento específico do hormônio do crescimento humano",
      "Perfil de ação diferente do hGH completo",
      "Desenvolvido principalmente para pesquisas relacionadas ao metabolismo e composição corporal",
    ],
  },
  "SLU-PP-322": {
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sim. Temos ampolas avulsas disponíveis das linhas Tirzec, TG e Lipoless, uma ótima opção para quem quer conhecer o produto antes de adquirir a caixa com 4 ampolas. Os valores estão disponíveis no catálogo.",
  },
  {
