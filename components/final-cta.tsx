  ...
  return (
    <section className="section-divider section-padding relative overflow-hidden bg-[#0E2238] text-white">
      ...
      <Container className="relative">
        <Reveal>
          <motion.div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-[#FFFFFF] px-6 py-12 text-[#10243A] shadow-[0_26px_80px_rgba(2,8,20,0.28)] sm:px-8 sm:py-14 lg:px-14 lg:py-16">
            ...
            <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
              <div className="max-w-3xl">
                <span className="inline-flex rounded-full border border-[#D8E1EA] bg-[#FFFFFF] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-[#153B63]">
                  Peça pelo WhatsApp
                </span>
